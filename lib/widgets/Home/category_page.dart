...
// lib/widgets/Home/category_page.dart
//
// KEY FIX: All provider mutations are wrapped in
//   WidgetsBinding.instance.addPostFrameCallback((_) { ... })
// so they never fire during a build/didUpdateWidget phase.
// This eliminates the "modified provider while widget tree was building" crash.
