...
class GridWidget extends StatelessWidget {
  ...
  const GridWidget({super.key, required this.section, this.onNavigate});
  ...
  Widget build(BuildContext context) {
    ...
    final cols = section.columns.clamp(1, 4);
    final rows = section.rows > 0 ? section.rows : null;
    final displayed = rows != null ? items.take(cols * rows).toList() : items;
    ...
    return SectionShell(
      ...
      child: GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          mainAxisSpacing: 10,
          crossAxisSpacing: 10,
          childAspectRatio: section.cardVariant == 'highlight' ? 0.58 : 0.68,
        ),
        itemBuilder: (_, i) {
